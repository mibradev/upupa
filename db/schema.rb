...
ActiveRecord::Schema[7.0].define(version: 2020_05_11_040540) do
  ...
  create_table "role_assignments", force: :cascade do |t|
    ...
    t.index ["role_id", "user_id"], name: "index_role_assignments_on_role_id_and_user_id", unique: true
  ...
  create_table "word_count_files", force: :cascade do |t|
    ...
    t.index ["work_file_id", "word_count_id", "work_type_id"], name: "index_word_count_files_on_work_file_&_word_count_&_work_type", unique: true
